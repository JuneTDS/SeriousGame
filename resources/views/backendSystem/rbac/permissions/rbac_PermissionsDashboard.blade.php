        ...
        <div class="col py-3">
            <div class="container custom-container">
                ...
                <div id="success-popup" class="popup-form">
                    ...
                    <p class="text-center" style="padding-top:50px">A new permission has been created.</p>
                </div>
                ...
                <div class="table-container">
                    <table class="table leftTable">
                        ...
                        <tbody style="background-color: #Neutral/50;">
                            @foreach ($permissions as $index => $permissionsData)
                            <tr style="color:#737B7F">
                                <td>{{ $index + 1 }}</td>
                                <td>{{ $permissionsData->name }}</td>
                                <td>{{ $permissionsData->description }}</td>
                                <td>
                                    @if (!empty($permissionsData->rule_name))
                                        {{ $permissionsData->rule_name }}
                                    @else
                                        (not set)
                                    @endif
                                </td>
                                <td>
                                    <div class="icon-container">
                                        <a href="{{ url('/admin/permissionInfo/' . $permissionsData->name) }}">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="{{ url('/admin/permissionEdit/' . $permissionsData->name) }}">
