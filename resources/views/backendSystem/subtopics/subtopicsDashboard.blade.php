...
<a href="/admin/topicsDashboard/{{ $topic[0]->subject_id_fk }}">
    <p class="align-self-center col-3" style="padding-left:0px;padding-bottom:20px;font-weight:bold"> ❮  Back to Manage Topics</p>
</a>
...
<div class="">
    ...
    <div id="success-popup" class="popup-form">
        <div class="row justify-content-center align-items-center ">
            ...
            <p class="text-center message" style="padding-top:50px">A new subtopic has been created.</p>
        </div>
