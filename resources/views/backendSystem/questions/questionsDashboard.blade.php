...
<a href="/admin/subtopicsDashboard/{{ $subtopics[0]->topic_id_fk }}">
    <p class="align-self-center col-3" style="padding-left:0px;padding-bottom:20px;font-weight:bold"> ❮  Back to Manage Subtopics</p>
</a>
